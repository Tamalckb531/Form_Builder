...
const Designer = () => {
  ...
  useDndMonitor({
    onDragEnd: (event: DragEndEvent) => {
      ...
      //? First scene : Adding new element each time on the last in queue
      ...
      //? Second scene : Adding new element on top and bottom of another element
      ...
      //? Third scene : Dragging one existing element on the top or bottom to other
