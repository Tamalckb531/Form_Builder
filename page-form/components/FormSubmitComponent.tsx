...
const FormSubmitComponent = ({
  ...
  const [renderKey, serRenderKey] = useState(new Date().getTime()); //Everytime the submitForm function run a new date will generate which will re-render the component
